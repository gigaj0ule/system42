...
/* Global variables ----------------------------------------------------------*/
extern communication communicable;
...
uint8_t oscilloscope_[OSCILLOSCOPE_CHANNELS][OSCILLOSCOPE_SIZE] = {0};
uint32_t oscilloscope_pos = 0;
...
public:
    ...
    void get_oscilloscope_val_void(int32_t channel, int32_t index) { 
        //oscilloscope_[channel][index]; 
    }
...
static inline auto make_obj_tree() {
    return make_protocol_member_list(
        ...
        make_protocol_string_kw(
            &communicable.device_make,  
            property_name = "make",             
            property_length = sizeof(communicable.device_make),     
            property_is_read_only = true
        ),
        make_protocol_string_kw(
            &communicable.device_model, 
            property_name = "model",            
            property_length = sizeof(communicable.device_model),    
            property_is_read_only = true
        ),
        ...
        make_protocol_object("vm",
            ...
            make_protocol_buffer_kw( 
                &oscilloscope_[0],
                property_name = "oscilloscope",
                property_length = OSCILLOSCOPE_SIZE,
                property_is_read_only = true
            )
        ),
