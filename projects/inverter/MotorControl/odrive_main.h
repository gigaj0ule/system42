...
#define OSCILLOSCOPE_SIZE 1024
#define OSCILLOSCOPE_CHANNELS 2
extern uint8_t oscilloscope_[OSCILLOSCOPE_CHANNELS][OSCILLOSCOPE_SIZE];
extern uint32_t oscilloscope_pos;
